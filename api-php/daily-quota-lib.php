...
/**
 * حد يومي صارم: عدد المتاجر المُعالَجة لكل موظف منذ 00:00:00 (CURDATE).
 * يُسجَّل: استبيان محفوظ، إكمال استعادة، إلخ — ولا يُسجَّل «لم يرد» من الطابور (لا يُحتسب ضمن الـ50).
 */
