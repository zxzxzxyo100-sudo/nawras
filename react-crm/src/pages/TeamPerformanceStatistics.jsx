      ...
      >
        ...
        <div className="rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50/90 via-white to-teal-50/40 p-5 lg:p-6">
          ...
          <p className="text-[11px] text-slate-500 mt-4 leading-relaxed border-t border-emerald-100/80 pt-4">
            «نشط» هنا = شحن ضمن آخر 14 يوماً من التاريخ المرجعي — نفس تعريف «نشط يشحن» في باقي النظام (بعد يوم 15
            يتحول إلى غير نشط ساخن). بداية الفترة = نهاية الشهر الماضي، نهاية الفترة = اليوم — بتوقيت الرياض. المصدر:
            بيانات الطرود المباشرة من منصة نورس.
          </p>
        </div>
      </motion.div>
