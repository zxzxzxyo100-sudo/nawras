...
/**
 * وضع التجريبي/التطوير: عناوين قصيرة وأسئلة مضغوطة (لا تغيّر ترتيب الحقول ولا تعارض مع استبيان المتاجر الجدد).
 */
const SATISFACTION_QUESTIONS_STAGING_UI = [
  {
    id: 'q1_delivery',
    short: 'سرعة التوصيل',
    text: 'قيّم سرعة وصول الشحنات للزبائن من 1 إلى 5.',
  },
  {
    id: 'q2_collection',
    short: 'سلوك المندوب والتجميع',
    text: 'قيّم التزام المندوب وخدمة التجميع/الاستلام من 1 إلى 5.',
  },
  {
    id: 'q3_support',
    short: 'الاستجابة والدعم',
    text: 'قيّم سرعة الرد وحل المشكلة عند التواصل مع الدعم من 1 إلى 5.',
  },
  {
    id: 'q4_app',
    short: 'سهولة التطبيق',
    text: 'قيّم سهولة التطبيق والتتبع وإدارة الطلبات من 1 إلى 5.',
  },
  {
    id: 'q5_payments',
    short: 'التسويات المالية',
    text: 'قيّم انتظام التسويات واستلام المستحقات من 1 إلى 5.',
  },
  {
    id: 'q6_returns',
    short: 'المرجوعات والخدمة الشاملة',
    text: 'قيّم سلامة المرجوعات والصورة العامة للخدمة من 1 إلى 5.',
  },
]

/** أسئلة العرض في نافذة المكالمة — نسخة مختصرة في التجريبي/التطوير فقط */
export function getSatisfactionQuestionsForUi() {
  return IS_STAGING_OR_DEV ? SATISFACTION_QUESTIONS_STAGING_UI : SATISFACTION_QUESTIONS
}
